...
var baseClassNames = (0, _getClassName.default)('ActionSheet');
  ...
  _createClass(ActionSheet, [{
    ...
    value: function waitTransitionFinish(eventHandler) {
      if (_transitionEvents.default.supported) {
        ...
        setTimeout(eventHandler.bind(this), _platform.IS_PLATFORM_ANDROID ? 200 : 300);
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_PopoutWrapper.default, {
        ...
        v: _platform.IS_PLATFORM_IOS ? 'bottom' : 'center',
        h: "center",
        className: className,
        style: style,
        onClick: this.onClose
      }, _react.default.createElement("div", _extends({}, restProps, {
        ref: this.getRef,
        onClick: this.stopPropagation,
        className: (0, _classNames.default)(baseClassNames, {
          'ActionSheet--closing': this.state.closing
        })
      }), _platform.IS_PLATFORM_IOS && _react.default.createElement("header", {
...
var _default = (0, _withInsets.default)(ActionSheet);
