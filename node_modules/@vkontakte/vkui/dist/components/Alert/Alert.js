...
var baseClassNames = (0, _getClassName.default)('Alert');
    ...
    value: function render() {
      ...
      return _react.default.createElement(_PopoutWrapper.default, {
        ...
        return _react.default.createElement(_Tappable.default, {
          component: "button",
          className: (0, _classNames2.default)('Alert__btn', _defineProperty({}, "Alert__btn--".concat(button.style), button.style)),
...
_defineProperty(Alert, "propTypes", {
  ...
  actionsLayout: _propTypes.default.oneOf(['vertical', 'horizontal']),
  actions: _propTypes.default.arrayOf(_propTypes.default.shape({
     ...
     * 'cancel' - iOS only
     */
    style: _propTypes.default.oneOf(['cancel', 'destructive', 'default'])
  })),
